...
Run each condition. Use 3 seeds for statistical confidence.

```bash
# Condition E — Exercise CNN (fast, ~5 min)
...
miniproject/
    ...
    results/            ← saved models, histories, plots (created automatically)
```
